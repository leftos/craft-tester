...
- [x] B. (landed 2026-09-15; over 1,000 seeds 1.29 attempts per draw, 16% correct as filed;
  ...
  the type ceiling" fault existed until 2026-09-16, when the ceiling rule was removed; the
  `dropped_transition` fault, a route missing the transition route building puts back, was added the
  same day). Retries until `resolveAmendments` is ok and reports exactly the injected boxes
