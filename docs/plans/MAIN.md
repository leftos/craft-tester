...
- [ ] **v2: free-text clearance entry** as an **alternative to** the dropdowns: the student types the
  ...
  graded, amendment mode included. The decisions and six steps are in the subplan. Steps 1-3 (structured
  reading, normaliser, matcher and grader) landed 2026-09-17; step 4 (results view) is next
